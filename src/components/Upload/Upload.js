...
const Upload = ({ loadFiles, jwtFromCookie, folders, setShowBreadcrumb, setLocation }) => {
    ...
    useEffect(() => {
        ...
        setLocation("upload");
        document.getElementById("dropdown-menu-align-right").classList.remove("btn-primary");
    }, []);
          ...
          myFiles.forEach((file, index) => {
            if (file.size > 2097152) {
              ...
              if (
                ...
                formData.append("tags", SelectedFolder == "None" ? "" : SelectedFolder );
    ...
    <Row>
        ...
        <Button
            ...
            onClick={() => { setInputFile(true); setShowFiles(false)}}
        >
            back to upload
        </Button>
        </Col>
    ...
    return (
        <>
            ...
            <Row>
                ...
                <Row>
                    <Col
                    style={{ display: inputFile ? "block" : "none" }}
                    >
                    <div
                        style={{
                        height: "100%",
                    ...
                    <Container style={{ marginTop: "10%" }}>
                        ...
                        >
                            ...
                            >
                                ...
                                {
                                    folders.map((folder) => 
                                        folder.name && <Dropdown.Item eventKey={folder.name}>{folder.name}</Dropdown.Item>
                                    )
                                }
                            </DropdownButton>
                        </Col>
                        ...
                        {loader && (
                            ...
                            <Col>
                                ...
                                animated
                                now={
                                    loadedAjax1 + loadedAjax2
                                }
                                label={`${
                                    Math.round(loadedAjax1) +
                                    Math.round(loadedAjax2)
                                }%`}
                                />
                            </Col>
